(function () {
    window.psAudio = function(obj){
        ...
        $('.audio-head').append($('<div class="audio-head-tittle"></div><div class="audio-head-tittle-by"></div><div class="audio-play-list audio-play-list-off"><div class="audio-play-list-all"></div></div>'));
